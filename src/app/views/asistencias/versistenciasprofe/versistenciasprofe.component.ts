...
@Component({
  selector: 'app-versistenciasprofe',
  templateUrl: './versistenciasprofe.component.html',
  styleUrls: ['./versistenciasprofe.component.scss'],
...
export class VerAsistenciasProfeComponent implements OnInit {
  myForm!: FormGroup;
